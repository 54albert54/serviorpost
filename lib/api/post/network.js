...
(0, secure_1.checkAuth)('follow'), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    (0, index_1.default)()
        ...
        .then((user) => (0, response_1.estatusSuccess)({ req, res, message: "le diste me gusta al post ID:" + postID }))
        .catch((error) => (0, response_1.estatusError)({ req, res, message: "error " + error }));
}));
routerPosts.delete("/:id", 
// //middleware
(0, secure_1.checkAuth)('delete'), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _b;
    const postId = (_b = req.params) === null || _b === void 0 ? void 0 : _b.id;
    const dataID = (0, auth_1.decodeHeader)(req).id;
    (0, index_1.default)()
        .deleted(postId, dataID)
        .then(() => (0, response_1.estatusSuccess)({ req, res, message: "Delete user info id " + dataID }))
        .catch((error) => (0, response_1.estatusError)({ req, res, message: "error " + error }));
}));
